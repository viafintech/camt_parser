module CamtParser
  class Xml
    def self.parse(doc)
      ...
      case namespaces
      when /^urn:iso:std:iso:20022:tech:xsd:camt.052.001.0\d$/
        return CamtParser::Format052::Base.new(doc.xpath('Document'))
      when /^urn:iso:std:iso:20022:tech:xsd:camt.053.001.0\d$/
        return CamtParser::Format053::Base.new(doc.xpath('Document'))
      when /^urn:iso:std:iso:20022:tech:xsd:camt.054.001.0\d$/
